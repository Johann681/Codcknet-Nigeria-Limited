...
const bookings = [
  ...
  ["Speed Limiter Sales & Installation", "limiter", "Approved speed limiter devices supplied, installed, and calibrated in line with Nigerian road safety requirements.", "/images/vehicle speedlimiter device.jpeg"],
