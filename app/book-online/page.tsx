...
export default function BookOnlinePage() {
  ...
  function handleLeadSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const waUrl = `https://wa.me/2349099522825?text=${encodeURIComponent(message)}`;
